...
- [x] 5. Implement SettingsManager
  - [x] 5.1 Create SettingsManager class
...
- [x] 6. Implement Clear Data UI
  - [x] 6.1 Add clear data button to settings UI
    - Create button in settings interface
    - Add confirmation dialog
    - Display data size before clearing
    - _Requirements: 1.5, 1.6_

  - [x] 6.2 Implement clear data handler
